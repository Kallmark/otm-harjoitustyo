...
public class LogicTest {
    ...
    public void saveUsersWorks() throws SQLException {
        ...
        logic.saveProduct("2", "Tuote", "10.0", "10", "Tuote");
    ...
    public void updateProductWorks() throws SQLException {
        ...
        logic.saveProduct("2", "Tuote", "10.0", "10", "Tuote");
        logic.saveProduct("2", "Tuote2", "20.0", "10", "Tuote");
    ...
    public void catchesErrorWhenSavingUser() {
        assertEquals(false, logic.saveUser("2", "Jaakko", "error"));
    }
    @Test
    public void catchesErrorWhenSavingProduct() {
        assertEquals(false, logic.saveProduct("2", "Tuote", "10.0", "error", "Tuote"));
    }
